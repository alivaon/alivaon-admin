        ...
        <div className="side-info">
          <div className="side-info-content">
            <div className="offset-widget offset-header">
              <div className="offset-logo">
                <a href={path(page.locale, 'app_home')}>
                  <img className="show-light" src={asset('build/images/logo/logo.png')} alt="site logo" />
                </a>
              </div>
            ...
            <div className="offset-button">
              <a href={path(page.locale, 'app_contact')} className="rr-btn">
                <span className="btn-wrap">
                  <span className="text-one">{t('side.start')}</span>
                  <span className="text-two">{t('side.a_project')}</span>
                </span>
              </a>
            </div>
            <div className="offset-widget-box">
              ...
              <div className="contact-meta">
                <div className="contact-item">
                  ...
                  <span className="text">Logpom, Douala, Cameroun</span>
                </div>
                <div className="contact-item">
                  <span className="icon">
                  ...
                  <span className="text">
                    <a href="mailto:contact@alivaon.com">contact@alivaon.com</a>
                  </span>
                </div>
                <div className="contact-item">
                  <span className="icon">
                  ...
                  <span className="text">
                    <a href="tel:+237691962158">+237 6 91 96 21 58</a>
                  </span>
                </div>
              </div>
            </div>
          ...
          <ul className="marqee-list d-flex">
            <li className="marquee-item">
              {items.map((item, index) => (
                ...
                <span key={index} className={index % 2 === 0 ? 'text-slider-1' : 'text-slider-2'}>
                  {item}
                </span>
              ))}
            </li>
